...
**We aim for Boule to be backwards compatible whenever possible and will make
...
.. seealso::
    ...
    `pyproject.toml file <https://github.com/fatiando/boule/blob/main/pyproject.toml>`__.
...
Boule supports Python versions greater than the ones listed below.
