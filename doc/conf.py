...
html_context = {
    ...
    'menu_links': [
        ...
        ('<i class="fa fa-users fa-fw"></i> Contributing', 'https://github.com/fatiando/boule/blob/master/CONTRIBUTING.md'),
        ('<i class="fa fa-gavel fa-fw"></i> Code of Conduct', 'https://github.com/fatiando/boule/blob/master/CODE_OF_CONDUCT.md'),
        ('<i class="fa fa-comment fa-fw"></i> Contact', 'http://contact.fatiando.org'),
        ('<i class="fa fa-github fa-fw"></i> Source Code', 'https://github.com/fatiando/boule'),
    ],
