...
class Sphere:
    ...
    **Units:** All input parameters and derived attributes are in SI units.
    ...
    def normal_gravity_potential(self, latitude, height):
        ...
        unlike the oblate ellipsoid, the gravity potential is not constant at
        the surface, and the normal gravity vector is not normal to the surface
        of the sphere.
    ...
    def normal_gravitational_potential(self, height):
        ...
        Computes the normal gravitational potential generated by the sphere
        at the given height above the surface of the sphere :math:`h`:
